...
* Device(s)    : RX Family
* Tool-Chain   : Renesas RX Standard Toolchain 2.07.00
* OS           : None
* H/W Platform :
...
#ifdef BSP_MCU_RX64M
static void rspi_spei_64m_isr(void *pdata);
#endif
#ifdef BSP_MCU_RX71M
static void rspi_spei_71m_isr(void *pdata);
#endif
#ifdef BSP_MCU_RX65N
static void rspi_spei_65n_isr(void *pdata);
#endif
/***********************************************************************************************************************
